...
class ProductTemplate(models.Model):
    ...
    def _compute_replenishment_cost(self):
        ...
        for rec in self:
            ...
            if (
                rec.uom_id != rec.uom_id
                and rec.uom_id.category_id == rec.uom_id.category_id
                and rec.uom_id.factor_inv != 0
            ):
                replenishment_cost = replenishment_cost * (rec.uom_id.factor_inv / rec.uom_id.factor_inv)
